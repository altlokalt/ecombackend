...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Rosalind72',
      password: 'hL2LgwenAosZfQ7',
      email: 'Dallas_Quitzon@yahoo.com',
      name: 'Gloria Koepp',
      shippingAddress: [
        {
          _id: false,
          pincode: 'Legacy',
          address1: 'experiences',
          address2: 'dedicated',
      ...
      userType: 374,
      mobileNo: '(259) 551-3999',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 701,
      loginReactiveTime: '2024-02-27T08:15:20.838Z',
      id: '641ebf529fbc54d2ba99c3d5'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Ramiro.Rogahn46',
        'password':'sq60fvJ9g6jtsWO',
        'email':'Madeline_Kuhlman24@hotmail.com',
        'name':'Nancy Conroy',
        'shippingAddress':[{
          '_id':false,
          'pincode':'implement',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Madeline_Kuhlman24@hotmail.com', });
