...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Hayden_Tromp',
      password: 'ouMaRpNanpdDpPR',
      email: 'Paris41@yahoo.com',
      name: 'Amos Abernathy',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 237,
      mobileNo: '(336) 827-6242',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 224,
      loginReactiveTime: '2023-07-07T04:17:24.962Z',
      id: '641ebf529fbc54d2ba99c4cb'
    });
  }
  catch (error) {
  ...
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        ...
        'password':'Kjhjbp2mtFi47YK',
        'email':'Leopoldo_Altenwerth43@gmail.com',
        'name':'Bobbie Reichel',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Glens',
        ...
        'wishlist':[{
          '_id':false,
          'productId':'info-mediaries'
        }],
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(450) 229-5171',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/desktop/auth/forgot-password')
      .send({ 'email':'Leopoldo_Altenwerth43@gmail.com', });
