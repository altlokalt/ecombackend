...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Olen.Heathcote77',
      password: 'Sxv_kvuxkseReXK',
      email: 'Sofia_Russel16@gmail.com',
      name: 'Boyd Connelly',
      shippingAddress: [
        {
          _id: false,
          pincode: 'Object-based',
          address1: 'optical',
          address2: 'Granite',
          landmark: 'intangible',
          city: 'Savings',
      ...
      userType: 370,
      mobileNo: '(344) 210-0738',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 298,
      loginReactiveTime: '2023-10-12T12:41:09.755Z',
      id: '641ebf529fbc54d2ba99c35a'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Jeffry_Wiza',
        'password':'OcEtYT94AprVdiP',
        'email':'Harvey.Schultz@gmail.com',
        'name':'Taylor Gerlach',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Licensed',
          'address1':'Chair',
          'address2':'directional',
          'landmark':'repurpose',
          'city':'XML',
          'isDefault':false,
          'state':'e-services',
          'addressType':'Specialist',
          'fullName':'group',
          'mobile':782,
          'addressNo':383
        }],
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Harvey.Schultz@gmail.com', });
