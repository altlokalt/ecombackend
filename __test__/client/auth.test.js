...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Kurtis_Labadie59',
      password: 'nuEzL8Rg72Tm5jW',
      email: 'Dayana74@yahoo.com',
      name: 'Melanie Weissnat',
      shippingAddress: [
        {
          _id: false,
          pincode: 'web-readiness',
          address1: 'generating',
          address2: 'Global',
          landmark: 'optical',
          city: 'Bermuda',
      ...
      userType: 54,
      mobileNo: '(157) 104-6939',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 986,
      loginReactiveTime: '2023-10-24T09:21:03.455Z',
      id: '641ebf529fbc54d2ba99c450'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Mike_Stroman56',
        'password':'oDL0d6Yp41UJ6TY',
        'email':'Maxime87@hotmail.com',
        'name':'Verna Boyer DVM',
        'shippingAddress':[{
          '_id':false,
          'pincode':'HDD',
          'address1':'Executive',
          'address2':'Shirt',
          'landmark':'eco-centric',
          'city':'silver',
          'isDefault':false,
          'state':'Chilean',
          'addressType':'sensor',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Maxime87@hotmail.com', });
